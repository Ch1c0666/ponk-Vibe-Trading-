...
// ---------------------------------------------------------------------------
// Segment detail view — uses shared ReviewedAStockDataPanel
// ---------------------------------------------------------------------------
function SegmentDetailView({ segment }: { segment: SegmentMeta }) {
  ...
  return (
    <div className="min-h-screen p-6 lg:p-8">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        <Link to="/ai-computing" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors w-fit">
        ...
        <section className="flex flex-col gap-4 border-b pb-6">
          <div className="space-y-3">
            ...
            <h1 className="text-3xl font-bold tracking-tight">{t(segment.labelKey as any)}</h1>
            <p className="text-sm text-muted-foreground">{t("aiComputing.detail.subtitle")}</p>
          </div>
        </section>

        <ReviewedAStockDataPanel scope="aiComputing" segmentKey={segment.key} />
